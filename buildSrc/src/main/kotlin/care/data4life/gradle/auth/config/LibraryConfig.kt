...
object LibraryConfig {
    ...
    const val group = "care.data4life.sdk.auth"
    const val name = "hc-auth-sdk-kmp"

    const val githubOwner = "d4l-data4life"
    const val githubRepository = "hc-auth-sdk-kmp"

    object PublishConfig {
        const val groupId = "care.data4life.hc-auth-sdk-kmp"
    ...
    object AndroidLibraryConfig {
        ...
        const val resourcePrefix = "hc_auth_"
    }
}
